...
(cl:defmethod cl:initialize-instance :after ((m <CANPacket>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CANPacket)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name can_test_pkg-msg:<CANPacket> is deprecated: use can_test_pkg-msg:CANPacket instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <CANPacket>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader can_test_pkg-msg:header-val is deprecated.  Use can_test_pkg-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'count-val :lambda-list '(m))
(cl:defmethod count-val ((m <CANPacket>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader can_test_pkg-msg:count-val is deprecated.  Use can_test_pkg-msg:count instead.")
  (count m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <CANPacket>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader can_test_pkg-msg:id-val is deprecated.  Use can_test_pkg-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'len-val :lambda-list '(m))
(cl:defmethod len-val ((m <CANPacket>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader can_test_pkg-msg:len-val is deprecated.  Use can_test_pkg-msg:len instead.")
  (len m))

(cl:ensure-generic-function 'dat-val :lambda-list '(m))
(cl:defmethod dat-val ((m <CANPacket>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader can_test_pkg-msg:dat-val is deprecated.  Use can_test_pkg-msg:dat instead.")
  (dat m))

(cl:ensure-generic-function 'flag-val :lambda-list '(m))
(cl:defmethod flag-val ((m <CANPacket>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader can_test_pkg-msg:flag-val is deprecated.  Use can_test_pkg-msg:flag instead.")
  (flag m))

(cl:ensure-generic-function 'time-val :lambda-list '(m))
(cl:defmethod time-val ((m <CANPacket>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader can_test_pkg-msg:time-val is deprecated.  Use can_test_pkg-msg:time instead.")
  (time m))
